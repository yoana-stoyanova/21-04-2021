...
int main()
{
    ...
    cout << "Biggest possible generated number = ";
    cin >> n;
    if(n == 0){
        cout << "you stopped the game";
        return 0;
    ...
    while (num2 != 0){
        if(num2 % 10 == 0 || num2 % 10 == 9 || num2 % 10 == 6){
            circles++;
        }
        if(num2 % 10 == 8){
            circles = circles + 2;
    ...
    while (guess != num){
        ...
        if (guess > num){
            ...
            tries++;
            if(tries == 5){
                cout << "HINT: There is/are " << circles << " circle(s) in the number; example - there are 3 circles in '86'.\n";
            }

            if(guess > n){
                cout << "Your number should be between " << m << " and " << n << endl;
            }
        } else if(guess<num){
            cout << "Too low!\n\n";
            tries++;
